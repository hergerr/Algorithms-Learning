...
//dodawanie na koniec
void List::addValueToTheEnd(int value) {
...
void List::addValueToTheStart(int value) {
    ListElement *temp = new ListElement();  //nowy element
    temp->setNumber(value);
...
void List::addValueOnPosition(int value, int index) {
...
void List::deleteLast() {     //analogicznie do powyzszego
    if (size == 0)
        return;
